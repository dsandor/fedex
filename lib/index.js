...
function FedEx(args) {
  ...
  var resources = {
    ...
    ship: {f: buildShipRequest, r: handleShipResponse, wsdl: 'ShipService_v26.wsdl', path: '/web-services', version: {ServiceId: 'ship', Major: 15, Intermediate: 0, Minor: 0}},
